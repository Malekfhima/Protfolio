          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a
                  href="https://github.com/Malekfhima/maladies_plantes.git"
                  target="_blank"
                  rel="noreferrer"
                >
            ...
            <div className="body">
              ...
              <p>
                Smart agriculture mobile application that detects plant diseases using computer vision and deep learning. Features camera integration, AI-powered detection, multi-language support, and detailed treatment recommendations.
              </p>
            </div>
            <footer>
